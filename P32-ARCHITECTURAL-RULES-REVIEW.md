...
- Required fields: `"version"`, `"author"` (note: `"relative_filename"` is optional and may be present for documentation only)
...

{
    ...
    // "relative_filename": "config/components/...",  # optional
