...
##  COMPONENT RELATIONSHIPS & JSON INTERPRETATION
...
- Required fields: `"version"`, `"author"` (note: `"relative_filename"` is deprecated and should not be used)
...

{
  ...
  // Deprecated: "relative_filename": "config/components/positioned/component_name.json",
...
##  PROVEN IMPLEMENTATION PATTERNS (FROM CODE ANALYSIS)
