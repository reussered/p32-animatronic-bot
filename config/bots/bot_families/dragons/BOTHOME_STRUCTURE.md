...
- **Components** (from flying_dragon_full.json subsystem):
  - `flying_dragon_left_eye<GC9A01>`  240240 IPS color display
  - `flying_dragon_right_eye<GC9A01>`  240240 IPS color display
  - `flying_dragon_mouth<GC9A01>`  240135 display
...
| `MG996R_SERVO.json` | Servo actuator | 11 kgcm torque, 50 Hz PWM, 55g | 6 qty |
