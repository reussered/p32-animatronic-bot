...
│
├── 🗂️ Part-Based Organization (Anatomy-Aligned)
...
| **MG996R_SERVO.json** | 11 kg⋅cm torque, 50 Hz PWM, 55g |
...
```
flying_dragon_head
├─ flying_dragon_left_eye<GC9A01>        [240×240 IPS display, SPI]
├─ flying_dragon_right_eye<GC9A01>       [240×240 IPS display, SPI]
├─ flying_dragon_mouth<GC9A01>           [240×135 display, SPI]
