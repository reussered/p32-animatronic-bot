...
├── MG996R_SERVO.json            (Servo: 11 kg⋅cm, 55g)
...
PWM Range: 1000 µs (zero) to 2000 µs (max), 490 Hz ESC frequency
...
**MG996R_SERVO**
- Torque: 11 kg⋅cm | Speed: 0.16 sec/60° | Weight: 55g | Control: 0-180°
