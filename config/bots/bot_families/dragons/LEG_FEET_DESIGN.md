...
**Mathematical Model**:
```
Left Hip Y:  L_hip_y = 40 * sin(2π * (phase - 0.0))
Right Hip Y: R_hip_y = 40 * sin(2π * (phase - 0.5))  // Opposite phase
...
Spring-damper system:
  ...
  F_damping = c * velocity          (c ≈ 5 N·s/m for TPE)
...
| Max servo temperature | <70°C during continuous walking |
...
### Hardware Files
- Servo specs: MG996R datasheet (20 kg·cm torque, 56 rpm no-load speed)
...
- Sufficient torque (20 kg·cm) for leg loading
...
- [ ] Servo pulse-width calibration (1000-2000 µs mapping)
...
- [ ] Temperature monitoring (servo limits <70°C)
