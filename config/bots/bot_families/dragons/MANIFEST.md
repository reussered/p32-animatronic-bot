...
✅ config/hardware/flying_dragon_leg_controller.json
   ...
   - PWM range: 1000-2000 µs (50 Hz servo standard)
   ...
   - Safety limits: 70°C warning, 80°C shutdown, 500ms watchdog
```
...
- Servo temperature monitoring (max <60°C during walking)
