...
void (*actTable[TABLE_SIZE])(void) = {
    ...
    spine_flexion_servo_act,    // [28] <describe the components purpose and functionality here>
    servo_sg90_micro_act,    // [29] Micro servo motor for precise position control in small animatronics
    spine_extension_servo_act,    // [30] <describe the components purpose and functionality here>
    servo_sg90_micro_act,    // [31] Micro servo motor for precise position control in small animatronics
    waist_rotation_servo_act,    // [32] <describe the components purpose and functionality here>
    servo_sg90_micro_act,    // [33] Micro servo motor for precise position control in small animatronics
    torso_status_led_act,    // [34] <describe the components purpose and functionality here>
    servo_sg90_micro_act,    // [35] Micro servo motor for precise position control in small animatronics
    torso_speaker_act,    // [36] <describe the components purpose and functionality here>
...
uint32_t hitCountTable[TABLE_SIZE] = {
    ...
    1,    // [28] spine_flexion_servo - every 1 loops
    1,    // [29] servo_sg90_micro - every 1 loops
    1,    // [30] spine_extension_servo - every 1 loops
    1,    // [31] servo_sg90_micro - every 1 loops
    1,    // [32] waist_rotation_servo - every 1 loops
    1,    // [33] servo_sg90_micro - every 1 loops
    1,    // [34] torso_status_led - every 1 loops
    1,    // [35] servo_sg90_micro - every 1 loops
    1,    // [36] torso_speaker - every 1 loops
