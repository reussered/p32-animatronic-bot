// P32 Component: goblin_ear_right
...
// Component: goblin_ear_right component
esp_err_t goblin_ear_right_init(void) {
#ifdef SIMPLE_TEST
    printf("INIT: goblin_ear_right - goblin_ear_right component\n");
    return ESP_OK;
#endif
...
void goblin_ear_right_act(void) {
    ...
    if (g_loopCount % 1000 == 0) {
        printf("ACT: goblin_ear_right - active (loop %llu)\n", g_loopCount);
    }
    return;
#endif
