 ...
 * @brief Battle-scarred pirate personality with enhanced aggression and treasure obsession
 * @author Auto-generated from JSON specification
 */

#include "components/goblin_pirate_personality.hpp"
...
/**
 * @brief Initialize goblin_pirate_personality component
...
/**
 * @brief Execute goblin_pirate_personality component logic  
