...
#define PIN_MOSI 13   // SDA (shared)
#define PIN_CLK  12   // SCL (shared - user confirmed)
#define PIN_CS   16   // Chip Select (right eye - different from left!)
#define PIN_DC   2    // Data/Command (shared)
#define PIN_RST  21   // Reset (shared)
...
esp_err_t goblin_eye_right_init(void)
{
    ...
    spi_device_interface_config_t dev_cfg = {
        ...
        .mode = 0,                            // SPI mode 0
        .spics_io_num = PIN_CS,              // CS pin for RIGHT eye (GPIO16)
        .queue_size = 7,
        .flags = 0,
        .pre_cb = NULL
    };
