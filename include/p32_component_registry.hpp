...
esp_err_t gpio_bus_init(void);
esp_err_t gpio_pair_driver_init(void);
esp_err_t gpio_single_driver_init(void);
...
esp_err_t goblin_left_cheek_init(void);
esp_err_t goblin_right_cheek_init(void);
esp_err_t goblin_left_eyebrow_init(void);
esp_err_t goblin_right_eyebrow_init(void);
esp_err_t goblin_jaw_init(void);
esp_err_t goblin_forehead_init(void);
...
void gpio_bus_act(void);
void gpio_pair_driver_act(void);
void gpio_single_driver_act(void);
...
void goblin_left_cheek_act(void);
void goblin_right_cheek_act(void);
void goblin_left_eyebrow_act(void);
void goblin_right_eyebrow_act(void);
void goblin_jaw_act(void);
void goblin_forehead_act(void);
