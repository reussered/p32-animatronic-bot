...
- **Left Eye**: 2  115KB = 230KB (240240 GC9A01)
- **Right Eye**: 2  115KB = 230KB (240240 GC9A01)  
- **Mouth**: 2  90KB = 180KB (300150 ST7789)
...
- **Eye Display**: 240 rows  15s = 3.6ms per eye
- **Both Eyes**: 7.2ms total
- **Mouth Display**: 150 rows  20s = 3.0ms
...
[goblin_mouth] Initializing mouth with double-buffered PSRAM (300150)
