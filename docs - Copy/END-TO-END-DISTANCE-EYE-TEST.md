...
void setup() {
    ...
    Serial.println("Display initialized (240240)");
...
void render_eye() {
    ...
    Serial.printf("  Eye rendered: color=%s, pupil=%d, size=%d\n",
...
Head:  " Received 'g_Envir' (2 bytes)"
       ...
       "   Mood: HAPPY=10, CURIOUS=20, FEAR=30"
       "  Eye rendered: color=BLUE, pupil=25, size=100"
...
Head:  " Received 'g_MOOD'"
       "  Eye rendered: color=YELLOW, pupil=35, size=100"
...
Head:  " Received 'g_MOOD'"
       "  Eye rendered: color=YELLOW, pupil=50, size=100"
       [Display: YELLOW eye, VERY DILATED pupils!] 
```

**6. Back away to 40cm**
```
Head:  "  Eye rendered: color=YELLOW, pupil=35, size=100"
       [Display: Pupils CONTRACT as you move away] 
```
...
RESULT: Move face  Eyes react in real-time! 
```
...
- Add 1k resistor on ECHO pin (voltage divider)
...
- [ ] 1 GC9A01 1.28" circular display 240240 ($10)
- [ ] 2 Breadboards ($4)
