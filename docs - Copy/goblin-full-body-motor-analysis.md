...
```json
{
  "head_yaw_motor": {
    ...
    "required_torque": "0.16 Nm static",
    "dynamic_requirement": "90 in 0.5s (brisk response)",
    "safety_factor": "2.5x",
    "final_requirement": "0.40 Nm (56 ozin)",
    "motor_selection": "NEMA 17 Standard (65 ozin)",
  ...
  "head_pitch_motor": {
    ...
    "required_torque": "0.20 Nm (reduced moment arm)",
    "safety_factor": "2.5x",
    "final_requirement": "0.50 Nm (71 ozin)", 
    "motor_selection": "NEMA 17 Standard (92 ozin)",
...
```json
{
  "torso_twist_motor": {
    ...
    "required_torque": "1.12 Nm static",
    "dynamic_requirement": "Upper body gestures", 
    "safety_factor": "3.0x (high importance)",
    "final_requirement": "3.36 Nm (475 ozin)",
    "motor_selection": "NEMA 17 High Torque (600+ ozin)",
  ...
  "torso_lean_motor": {
    ...
    "required_torque": "2.8 Nm (major structural load)",
    "safety_factor": "3.0x",
    "final_requirement": "8.4 Nm (1188 ozin)",
    "motor_selection": "NEMA 23 (1200+ ozin)",
...
```json
{
  "shoulder_roll_motor": {
    ...
    "required_torque": "0.48 Nm static",
    "safety_factor": "2.5x",
    "final_requirement": "1.2 Nm (170 ozin)",
    "motor_selection": "NEMA 17 Standard (178 ozin)",
  ...
  "shoulder_pitch_motor": {
    ...
    "required_torque": "0.45 Nm",
    "final_requirement": "1.13 Nm (160 ozin)", 
    "motor_selection": "NEMA 17 Standard (178 ozin)",
  ...
  "elbow_motor": {
    ...
    "required_torque": "0.24 Nm",
    "safety_factor": "2.0x (lighter load)",
    "final_requirement": "0.48 Nm (68 ozin)",
    "motor_selection": "NEMA 14 (84 ozin)",
  ...
  "wrist_motors_3x": {
    ...
    "required_torque": "0.09 Nm each",
    "safety_factor": "2.0x",
    "final_requirement": "0.18 Nm (25 ozin) each",
    "motor_selection": "28BYJ-48 Stepper (35 ozin)",
...
```json
{
  ...
  "hip_pitch_motor": {
    ...
    "required_torque": "1.8 Nm base + 2x walking",
    "safety_factor": "3.0x",
    "final_requirement": "10.8 Nm (1527 ozin)",
    "motor_selection": "NEMA 23 (1600+ ozin)", 
  ...
  "knee_motor": {
    ...
    "safety_factor": "2.5x",
    "final_requirement": "1.35 Nm (191 ozin)",
    "motor_selection": "NEMA 17 Standard (200 ozin)",
  ...
  "ankle_motors_3x": {
    ...
    "safety_factor": "2.0x",
    "final_requirement": "0.35 Nm (49 ozin) each",
    "motor_selection": "NEMA 14 (84 ozin)",
...
```json
{
  "wheel_drive_motors": {
    ...
    "torque_at_wheel": "12 Nm per wheel (4 wheels)",
    "gear_reduction": "20:1 recommended",
    "motor_requirement": "0.6 Nm at motor shaft",
    "safety_factor": "2.0x",
    "final_requirement": "1.2 Nm (170 ozin)",
    "motor_selection": "NEMA 17 Standard (178 ozin)",
...
```json
{
  "nema_23_applications": {
    "torso_lean": "8.4 Nm required",
    "hip_pitch_left": "10.8 Nm required", 
    "hip_pitch_right": "10.8 Nm required",
    "recommended_spec": {
      "holding_torque": "12 Nm (1700 ozin)",
      "rated_current": "3.0A",
      "step_angle": "1.8",
...
```json
{
  "nema_17_high_torque_applications": {
    "torso_twist": "3.36 Nm required",
    "hip_roll_left": "4.2 Nm required",
    "hip_roll_right": "4.2 Nm required", 
    "shoulder_roll_left": "1.2 Nm required",
    "shoulder_roll_right": "1.2 Nm required",
    "shoulder_pitch_left": "1.13 Nm required",
    "shoulder_pitch_right": "1.13 Nm required",
    "recommended_spec": {
      "holding_torque": "4.5 Nm (600+ ozin)",
      "rated_current": "2.0A",
      "step_angle": "1.8", 
...
```json
{
  "nema_17_standard_applications": {
    "head_yaw": "0.40 Nm required",
    "head_pitch": "0.50 Nm required",
    "knee_left": "1.35 Nm required",
    "knee_right": "1.35 Nm required",
    "wheel_drive_4x": "1.2 Nm each required",
    "mobility_steering": "0.8 Nm required",
    "recommended_spec": {
      "holding_torque": "1.5 Nm (200+ ozin)",
      "rated_current": "1.2A",
      "step_angle": "1.8",
...
```json
{
  "nema_14_applications": {
    "elbow_left": "0.48 Nm required",
    "elbow_right": "0.48 Nm required", 
    "ankle_pitch_left": "0.35 Nm required",
    "ankle_pitch_right": "0.35 Nm required",
    "ankle_roll_left": "0.35 Nm required", 
    "ankle_roll_right": "0.35 Nm required",
    "ankle_yaw_left": "0.35 Nm required",
    "ankle_yaw_right": "0.35 Nm required",
    "recommended_spec": {
      "holding_torque": "0.6 Nm (84+ ozin)",
      "rated_current": "0.8A",
      "step_angle": "1.8",
...
```json
{
  "small_stepper_applications": {
    "wrist_roll_left": "0.18 Nm required",
    "wrist_pitch_left": "0.18 Nm required",
    "wrist_yaw_left": "0.18 Nm required", 
    "wrist_roll_right": "0.18 Nm required",
    "wrist_pitch_right": "0.18 Nm required",
    "wrist_yaw_right": "0.18 Nm required",
    "recommended_spec": {
      "holding_torque": "0.25 Nm (35 ozin)",
      "voltage": "5V",
      "step_angle": "5.625",
