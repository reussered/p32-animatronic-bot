...
-  PWM pulse-width mapping (1000-2000 s, 1500 neutral)
...
-  Safety limits (max 20 kgcm torque, 70C warning, 80C shutdown)
...
- [ ] Verify servo temperatures remain <70C during continuous walking
...
- Servo torque margin: 20 kgcm per servo (sufficient for ~2kg per-leg loading)
