...
** MOUTH DISPLAY REMOVED** - Your display has no exposed pins, so we'll use just 2 eyes.
...
3. **Check for shorts**:
   ...
   - Measure resistance between 5V and GND (should be >1k)
...
### Test 3: Sensor Test
1. HC-SR04: Send 10s pulse on TRIG (GPIO 9)
