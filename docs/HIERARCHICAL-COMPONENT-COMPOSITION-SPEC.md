# Hierarchical Component Composition Architecture
   ...
   // "relative_filename": "config/bots/goblin_full.json",  # optional

## CRITICAL PRINCIPLE: Assembly Components

   // "relative_filename": "config/subsystems/goblin_head.json",  # optional

**A component can contain other components.**

   // "relative_filename": "config/components/positioned/goblineye_left.json",  # optional
