 ...
 **Maximum current from 3V3 pin**: 600mA (theoretical)  
 **Safe continuous current**: 450mA (recommended)  
 **Our design**: 265mA ( safe)
...
- Logic level shifters for 5V3.3V signals
...
**Solution:**
1. Add 100F capacitor between 3V3 and GND (near ESP32)
2. Add 10F capacitor near each display VCC/GND
...
| Red jumper wire (3V3breadboard) | 1 | Power distribution | $0.10 |
| Black jumper wire (GNDbreadboard) | 1 | Ground return | $0.10 |
...
| Item | Quantity | Purpose | Cost |
|------|----------|---------|------|
| 100F electrolytic capacitor | 1 | Bulk decoupling (ESP32) | $0.25 |
| 10F ceramic capacitor | 2 | Local decoupling (displays) | $0.50 |
