...
|-----------|------|----------|----------------|
| **Audio Amplifier** | I2S/Analog | Few days |  Skip audio output tests |
| **Speakers** | 40mm drivers | Few days |  Skip audio output tests |
...
```json
{
  ...
  "notes": "Using Adafruit #3885 - 40mm 4 3W speaker"
}
```
...
**Blocked Testing**:  Audio output (speakers on order)  
