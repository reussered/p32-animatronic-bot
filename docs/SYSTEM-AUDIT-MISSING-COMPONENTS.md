...
#### 10. **goblin_family.json** - INCOMPLETE 
...
#### 11. **goblin_ear_left.json** - VERSION MISMATCH 
...
#### 12. **goblin_ear_right.json** - VERSION MISMATCH 
...
#### 13. **goblin_mouth.json** - VERSION MISMATCH 
...
#### 21. **directional_microphone.json** - WRONG COMPONENT TYPE 
...

{
  ...
  // "relative_filename": "config/components/system/system_core.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/system/network_monitor.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/system/watchdog.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/system/power_monitor.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/system/bluetooth_central.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/system/serial_console.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/functional/goblin_personality.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/functional/goblin_mood.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/functional/goblin_behavior_engine.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/hardware/hw496_microphone.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/positioned/goblin/head_components/goblin_ear_left.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/interfaces/adc_pin_35.json",  # optional
...

{
  ...
  // "relative_filename": "config/components/interfaces/adc_pin_36.json",  # optional
